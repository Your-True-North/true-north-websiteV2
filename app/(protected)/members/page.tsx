  ...
  if (loading) {
    return (
      <div style={{ minHeight: '100vh', background: '#ffffff', display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
        <div style={{ color: '#999', fontWeight: 300 }}>Entering portal...</div>
      </div>
    )
  }
      ...
      <div style={{ position: 'sticky',
        ...
        <div style={{ textAlign: 'center', marginBottom: '3rem' }}>
          <div style={{ display: 'inline-block', marginBottom: '1.5rem' }}>
            <div style={{
              ...
              {!profilePhoto && (
                <svg style={{ width: '2.5rem', height: '2.5rem', color: '#333' }} fill="none" stroke="currentColor" viewBox="0 0 24 24">
          ...
          <h1 style={{
            ...
            Welcome back, <span style={{ color: '#666' }}>{user.name}</span>
          </h1>
          <p style={{ color: '#999', fontSize: 'clamp(1rem, 2vw, 1.125rem)', fontWeight: 300 }}>
        ...
        top: 0, display: 'flex', justifyContent: 'center' }}>
                ...
                <div style={{
                  ...
                  <div style={{ fontSize: '0.75rem', color: '#999', fontWeight: 300, marginTop: '0.25rem' }}>
                    Complete
                  </div>
                </div>
              </div>
              ...
              {[
                ...
                >
                  ...
                  <div style={{ flex: 1, minWidth: 0 }}>
                    ...
                    <div style={{ fontSize: '0.875rem', color: '#999', fontWeight: 300 }}>{action.desc}</div>
                  </div>
                  <svg style={{ width: '1.25rem', height: '1.25rem', color: '#bbb', flexShrink: 0, transition: 'all 0.3s ease' }} fill="none" stroke="currentColor" viewBox="0 0 24 24">
...
Your Progress
          ...
          <div style={{
            ...
            <div style={{
              ...
              <div style={{ fontSize: '0.875rem', color: '#999', fontWeight: 300 }}>
                Videos Watched
              </div>
            </div>
        ...
        <div style={{
          ...
          <h3 style={{ fontSize: 'clamp(1.125rem, 2.5vw, 1.25rem)', fontWeight: 300, marginBottom: '1.5rem', display: 'flex', alignItems: 'center', gap: '0' }}>
            <svg style={{ width: '1.25rem', height: '1.25rem', color: '#666' }} fill="none" stroke="currentColor" viewBox="0 0 24 24">
          ...
          <div style={{
            ...
            <div>
              <div style={{ fontSize: '0.75rem', letterSpacing: '0.05em', color: '#999', marginBottom: '0.5rem', fontWeight: 300 }}>
                EMAIL ADDRESS
              </div>
            ...
            <form onSubmit={handleProfileUpdate} style={{ padding: '1.5rem' }}>
              ...
              <div style={{ textAlign: 'center', marginBottom: '2rem' }}>
                <div style={{
                  ...
                  {!profilePhoto && (
                    <svg style={{ width: '2.5rem', height: '2.5rem', color: '#999' }} fill="none" stroke="currentColor" viewBox="0 0 24 24">
                      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M16 7a4 4 0 11-8 0 4 4 0 018 0zM12 14a7 7 0 00-7 7h14a7 7 0 00-7-7z" />
                    </svg>
                  )}
                </div>
              ...
              <div style={{ marginBottom: '1.5rem' }}>
                <label style={{ display: 'block', color: '#666', fontSize: '0.875rem', marginBottom: '0.5rem' }}>
                  Name
                </label>
                <input
                  type="text"
