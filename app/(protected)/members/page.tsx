                ...
                return (
                  <Link
                    ...
                    style={{
                      ...
                      gap: '1rem',
                      padding: '1rem',
                      background: isActive ? 'rgba(155, 196, 184, 0.1)' : 'rgba(255, 255, 255, 0.05)',
                      border: isActive ? '1px solid rgba(155, 196, 184, 0.3)' : '1px solid rgba(255, 255, 255, 0.1)',
                      borderRadius: '8px',
                      textDecoration: 'none',
                      color: '#fff',
                      transition: 'all 0.3s ease'
                    ...
                    onMouseEnter={(e) => {
                      e.currentTarget.style.background = isActive ? 'rgba(155, 196, 184, 0.15)' : 'rgba(255, 255, 255, 0.1)'
                      e.currentTarget.style.borderColor = isActive ? 'rgba(155, 196, 184, 0.4)' : 'rgba(255, 255, 255, 0.2)'
                    }}
                    onMouseLeave={(e) => {
                      e.currentTarget.style.background = isActive ? 'rgba(155, 196, 184, 0.1)' : 'rgba(255, 255, 255, 0.05)'
                      e.currentTarget.style.borderColor = isActive ? 'rgba(155, 196, 184, 0.3)' : 'rgba(255, 255, 255, 0.1)'
                    }}
                  >
                  <div style={{
                    width: '3rem',
